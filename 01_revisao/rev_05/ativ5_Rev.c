...
// -> Função auxiliar de "RealizaMovimentos";
// Verifica se o entorno do personagem do jogador está livre, ou seja, verifica se ele pode a casa ao lado, ou acim aou abaixo está livre para realizar movimento na direção desejada;
int VerificaEntorno(int posicao) {
    	return posicao;
}

//-> Função auxiliar de "RealizaMovimentos";
// - Registra em um Vetor (Matriz, nesse caso)  as posições já percorridas pelo jogador no mapa;
...
// -> Função auxiliar de "RealizaMovimentos";
// - Verifica se o jogador já passou pela posição ao qual irá fazer o movimentos;
