...
/**
 * @brief Forma um numero em octal;
 * 
 * @param octal numero na base octal 
 * @param resto resto da divisao sucessiva;
 * @param cont_Digitos Quantidade de digitos que o numero possui
 * @return int 
 */
